...
classdef Navigation < handle
    ...
    methods
        ...
        function nav = Navigation(varargin)
            ...
            if nargin >= 1
                ...
                elseif isa(varargin{1}, "binaryOccupancyMap")
                    ...
                    w2g = bogMap.world2grid([0 0]);
                    nav.w2g = SE2(w2g(1), w2g(2), 0);
                end
            end            
        ...
        function plot_bg(nav, varargin)
            ...
            % Convert grid cell [1 1] to world coordinates
            gridOrigin = nav.w2g.inv * [1 1]';
            ...
            if isempty(opt.distance) || all(all(~isfinite(opt.distance)))
                ...
                image(gridOrigin(1), gridOrigin(2), occGrid+1, 'CDataMapping', 'direct', ...
                    'AlphaData', occGrid);
                colormap(cmap)
